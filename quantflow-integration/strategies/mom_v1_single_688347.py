# -*- coding: utf-8 -*-
# 冻结 v1 的单股版 —— universe 换成 688347.SH(科创板个股),其余逻辑一字未动。
# 单股下轮动退化为择时:动量>0 且价>60日线则持有;破20日线/回撤8% 离场。
# ⚠ 个股波动远大于ETF;科创板 200股起买;比赛只算ETF,本策略仅研究/纸面用。
