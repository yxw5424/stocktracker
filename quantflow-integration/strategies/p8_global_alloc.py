# -*- coding: utf-8 -*-
# P8 全球化配置·月再平衡 —— P1的分散化升级:A股30/纳指15/国债35/黄金20。
# 逻辑:中美股市牛熊不同步,加低相关资产=用分散(唯一免费午餐)而非预测,
# 同时提高牛市参与度(总股票仓45%)与降低单一市场依赖。
# 风险如实记:跨境ETF有溢价波动(场内价可偏离净值),QDII额度紧张期溢价放大。
# 原注释:静态配置月再平衡,
...
W = {'510300.SH': 0.30, '513100.SH': 0.15, '511260.SH': 0.35, '518880.SH': 0.20}
